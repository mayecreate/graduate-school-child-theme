...
if($news_options) { ?>
        ...
        <?php $text_alignment = $news_options['text_alignment']; ?>
...
<?php if ($featured_image_placement == "Left" && $show_a_featured_image == "Yes") {  
	$featured_image_placement_class_1 = "col-lg-6";
	$featured_image_placement_class_2 = "col-lg-6";
} elseif ($featured_image_placement == "Right" && $show_a_featured_image == "Yes") {
	$featured_image_placement_class_1 = "col-lg-6 order-lg-2";
	$featured_image_placement_class_2 = "col-lg-6 order-lg-1";
...
<?php } elseif ($alternate_link && ('' == get_post()->post_content)) { ?>
<a href="<?php echo $alternate_link; ?>" class="post_link_wrapper wide <?php echo $text_alignment; ?>" target="_blank">
<?php } else { ?>
<a href="<?php the_permalink(); ?>" class="post_link_wrapper wide <?php echo $text_alignment; ?>">
<?php } ?>
	...
	<?php } ?>
		<div class="<?php echo $featured_image_placement_class_2; ?>">
			...
			<?php if ($show_a_button_in_the_post_loop == "Yes") { ?>
				<span class="btn-mayecreate large <?php echo $text_alignment; ?>"><?php echo $button_text; ?></span>
			<?php } ?>
		</div>
	</div>
<?php if (is_admin()) { ?>
