...
function register_acf_block_types() {
	...
	// register a Professional Development Subjects block.
	acf_register_block_type(
		array(
			'name'              => 'development-subjects',
			'title'             => __('Professional Development Subjects'),
			'description'       => __('Add professional development subjects block to your page.'),
			'render_template'   => 'blocks/development-subjects.php',
			'category'          => 'formatting',
			'icon'              => 'admin-post',
			'keywords'          => array( 'page', 'projects', 'project' ),
		)
	...
	acf_register_block_type(
		array(
			...
			'description'       => __('Add featured events block to your page.'),
			'render_template'   => 'blocks/featured-events.php',
			'category'          => 'formatting',
			'icon'              => 'admin-post',
			'keywords'          => array( 'event', 'events', 'featured' ),
		)
	);
	// register a Spotlight block.
	acf_register_block_type(
		array(
			'name'              => 'mc-spotlight',
			'title'             => __('MC Spotlight'),
			'description'       => __('Add spotlight block to your page.'),
			'render_template'   => 'blocks/mc-spotlight.php',
			'category'          => 'formatting',
			'icon'              => 'admin-post',
			'keywords'          => array( 'spotlight', 'spotlights', 'featured' ),
		)
	);
	...
	acf_register_block_type(
		array(
			'name'              => 'mc-staff',
			'title'             => __('MC Staff'),
			'description'       => __('Add staff block to your page.'),
			'render_template'   => 'blocks/mc-staff.php',
			'category'          => 'formatting',
			'icon'              => 'admin-post',
			'keywords'          => array( 'staff', 'featured' ),
		)
	);
	// register a PFF block.
	acf_register_block_type(
		array(
			'name'              => 'mc-pff',
			'title'             => __('MC PFF'),
			'description'       => __('Add PFF Faculty block to your page.'),
			'render_template'   => 'blocks/mc-pff.php',
			'category'          => 'formatting',
			'icon'              => 'admin-post',
			'keywords'          => array( 'PFF', 'featured', 'faculty' ),
		)
	);
	// register a REP block.
	acf_register_block_type(
		array(
			'name'              => 'mc-rep',
			'title'             => __('MC REP'),
			'description'       => __('Add REP Faculty block to your page.'),
			'render_template'   => 'blocks/mc-rep.php',
			'category'          => 'formatting',
			'icon'              => 'admin-post',
			'keywords'          => array( 'PFF', 'featured', 'faculty' ),
		)
	);
	// register a DGS block.
	acf_register_block_type(
		array(
			'name'              => 'mc-dgs',
			'title'             => __('MC DGS'),
			'description'       => __('Add DGS Roster block to your page.'),
			'render_template'   => 'blocks/mc-dgs.php',
			'category'          => 'formatting',
			'icon'              => 'admin-post',
			'keywords'          => array( 'dgs', 'featured', 'roster' ),
		)
	);
}
